...
def Modified_acceleration(quaternion, acceleration):
    ...
    modified_acc[0] = modified_acc_mag_bias[0]* math.cos(0.43*to_rad)+modified_acc_mag_bias[1]*math.sin(0.43*to_rad)
    modified_acc[1] = modified_acc_mag_bias[1]*math.cos(0.43*to_rad)- modified_acc_mag_bias[0]*math.sin(0.43*to_rad)'''
...
while True:
    ...
    '''try:
        ...
        print("Position x, y, z: ", position_x, position_y, position_z)
        print("velocity x, y, z: ", velocity_x, velocity_y, velocity_z)
    ...
    print("accel, y_p_r, quater", acceleration, y_p_r, quaternion)
    try:
        if(gps[0] !=0):
            print("accel, y_p_r, quater, GPS:", acceleration, y_p_r, quaternion, gps)
    except:
        continue
